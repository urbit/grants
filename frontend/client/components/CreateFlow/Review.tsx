    ...
    const sections: Section[] = [
      {
        ...
        fields: [
          ...
          {
            key: 'category',
            content: <div style={{ color: catUI.color }}>{catUI.label}</div>,
            error: errors.category,
          },
          {
            key: 'target',
            content: <div style={{ fontSize: '1.2rem' }}>{form.target} STARS</div>,
            error: errors.target,
          },
        ],
      },
        ...
        fields: [
          {
            ...
            error:
              errors.milestones &&
              errors.milestones.map((e, i) => <div key={i}>{e}</div>),
          },
        ],
      },
    ];
